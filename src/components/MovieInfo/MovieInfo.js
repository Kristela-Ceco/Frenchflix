            ...
            <section className="movie-info-view">
                ...
                <div className="movie-info-container">
                    <div className="movie-info-row">
                            ...
                            <p style={{ color:"#FEFEFE", margin:"0px" }}>Évaluation: <span style={{ color:"#888" }}>{ this.state.movie.vote_average }/10</span></p>
                            <p style={{ color:"#FEFEFE" }}>Durée: <span style={{ color:"#888" }}>{ this.state.movie.runtime } minutes</span></p>
                    </div>
