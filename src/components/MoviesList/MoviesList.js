                ...
                <Link key={i} to={ `/movies/${movie.id}` } style={{ textDecoration: "none", width: "20%"}}>
                    <div className= "movie-card" data-title= { movie.original_title } data-desc= { movie.overview } data-rating= { movie.vote_average } data-backdrop= { `http://image.tmdb.org/t/p/w1280${movie.backdrop_path}` } ref= {(ref) => { this.movie= ref; this.pushRef(ref); } }>
                        ...
                        <div className= "movie-card-info">
                            <p>Libération: { movie.release_date.substring(0,4) }</p>
        ...
        return(
            <section className="moviesList-view">
                ...
                <InfiniteScroll    
                    ...
                    <h2 className="heading">Lecture en cours</h2>
                    <CSSTransitionGroup
                        transitionName="fade"
                ...
                <InfiniteScroll    
                    ...
                    <h2 className="heading">Résultats</h2>
                    <CSSTransitionGroup
                ...
                <div className="filters">
                    ...
                    <button onClick={ () => this.submitSearch() } style={{fontSize : "11px"}} className="btn submit-btn">Trouver des films</button>   
                </div>
            </section>
        )
    }
