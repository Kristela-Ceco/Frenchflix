...
app.get("/api/movies", (req, res, next) => {
    axios.get(`${process.env.API_URL}?api_key=${process.env.API_KEY}&language=fr-CA`)
...
app.get("/api/details/:id", (req, res, next) => {
    axios.get(`${process.env.DETAILS_URL}/${req.params.id}?api_key=${process.env.API_KEY}&language=fr-CA`)
...
app.get("/api/filter", (req, res, next) => {
    axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${process.env.API_KEY}&language=fr-CA`
